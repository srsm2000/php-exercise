...
class Taxi extends Car
{
    ...
    public function pickUp($get_on)
    {
        $this->passenger = $this->passenger + $get_on;
    }

    public function lower($get_off)
    {
        if ( $this->passenger - $get_off >= 0) {
            $this->passenger = $this->passenger - $get_off;
            echo $get_off . "人降車しました。";
        } else {
            echo "降車人数に誤りがあります";
        }
    }
